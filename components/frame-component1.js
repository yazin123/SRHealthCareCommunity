    ...
    >
      <div className="w-[777px] mt-32 flex flex-col items-start justify-start gap-[30px] max-w-full z-[3] ">
        <div className="self-stretch flex flex-col items-start justify-start gap-3.5">
          ...
          <div className="self-stretch relative z-[3] text-5xl font-light text-darkslategray mq450:text-lgi">
        ...
        <button className="cursor-pointer [border:none] py-[21px] pl-8 pr-[31px] bg-darkslateblue-200 rounded-lg flex flex-row items-start justify-start gap-[18px]">
          ...
          <a href="tel:+919447008356" className="relative text-9xl [text-decoration:none] font-lexend-deca text-white text-left mq450:text-3xl">
            Get in touch
          </a>
        </button>
      </div>
